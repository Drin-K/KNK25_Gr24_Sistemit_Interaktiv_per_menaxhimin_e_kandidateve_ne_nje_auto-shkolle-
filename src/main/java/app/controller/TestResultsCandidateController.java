...
public class TestResultsCandidateController extends BaseController {
    ...
    @FXML
    private TableView<Testet> overallResults;
    @FXML
    private TableColumn<Testet, Integer> pointsView;
    @FXML
    private TableColumn<Testet, String> examType;
    @FXML
    private TableColumn<Testet, LocalDate> dateHeld;
    @FXML
    private TableColumn<Testet, String> resultStatus;
