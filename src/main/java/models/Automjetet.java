...
public class Automjetet {
    ...
    private Automjetet(int id_automjet, String lloji_i_automjetit, String statusi, int id_staf, int id_kategori) {
    ...
    public static Automjetet getInstance(ResultSet result) throws SQLException{
        ...
        String lloji_i_automjetit = result.getString("lloji_i_automjetit");
